...
class Network(object):
    ...
    def SGD(self,max_accuracy, training_data, epochs, mini_batch_size, eta,
            lmbda = 0.0,
        ...
        for j in range(epochs):
            ...
            if monitor_evaluation_accuracy:
                ...
                if accuracy > max_accuracy:
                    self.save("bestmodel.json")
                    max_accuracy = accuracy
                    print("[Validation accuracy]: {} / {}".format(self.accuracy(evaluation_data), n_data))
    ...
    def update_mini_batch(self, mini_batch, eta, lmbda, n):
        ...
        for x, y in zip(*mini_batch):
                #print("Shape is: {0}".format(np.shape(x)))
